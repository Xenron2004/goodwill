...
//         <button 
//           onClick={toggleDropdown} 
//           className="text-[#06082E] hover:text-gray-600 transition-colors duration-200"
//         >
//           <Equal size={28} />
//         </button>
//       </div>
...
//       <div
//         className={`fixed inset-0 bg-[#B8956A] z-[100] transform transition-all duration-500 ease-in-out ${
//           dropdownOpen 
...
//             className="text-white hover:text-gray-200 transition-colors duration-200 flex items-center gap-2 text-lg"
//           >
...
//                   href={item.path}
//                   onClick={closeDropdown}
//                   className={`block text-2xl md:text-3xl font-light text-white hover:text-gray-200 transition-all duration-300 transform hover:translate-x-2 ${
//                     index === 0 ? 'text-white font-normal' : 'text-white/70'
//                   }`}
//                   style={{
//                     animationDelay: `${index * 0.1}s`,
//                     animation: dropdownOpen ? 'slideInLeft 0.6s ease-out forwards' : 'none'
//                   }}
//                 >
//                   {item.name}
//                 </Link>
...
//                   href={link.path}
//                   onClick={closeDropdown}
//                   className="block text-lg text-white hover:text-gray-200 transition-colors duration-200 border-b border-white/20 pb-2"
//                   style={{
...
//                 animationDelay: '0.3s',
//                 animation: dropdownOpen ? 'slideInUp 0.8s ease-out forwards' : 'none'
//               }}>
...
//                     animation: dropdownOpen ? 'slideInUp 0.6s ease-out forwards' : 'none'
//                   }}
//                 >
//                   {social.name}
//                 </Link>
...
//         <button 
//           onClick={toggleDropdown} 
//           className="text-[#06082E] hover:text-gray-600 transition-colors duration-800"
//         >
//           <Equal size={28} />
//         </button>
//       </div>
...
//       {/* Full-Screen Dropdown Menu */}
//       <div
//         className={`fixed inset-0 bg-[#B8956A] z-[100] transform transition-all duration-1000 ease-in-out ${
//           dropdownOpen 
//             ? "translate-y-0 opacity-100" 
//             : "-translate-y-full opacity-0"
//         }`}
...
//                     animation: dropdownOpen ? 'slideInLeft 1s ease-out forwards' : 'none'
//                   }}
//                 >
//                   {item.name}
//                 </Link>
...
//                   className="block text-lg text-white hover:text-gray-200 transition-colors duration-200 border-b border-white/20 pb-2"
//                   style={{
//                     animationDelay: `${(sidebarItems.length + index) * 0.8}s`,
//                     animation: dropdownOpen ? 'slideInLeft 1s ease-out forwards' : 'none'
//                   }}
//                 >
//                   {link.name}
...
const Navbar = () => {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <div className="hidden z-50 md:flex w-full max-w-full h-[91px] relative bg-white mx-auto">
        <div className="w-[335px] bg-white relative flex justify-center items-center custom-clip z-10">
          <Link href="/" passHref>
            <div className="w-[px] flex justify-start items-center">
              <Image
        ...
        <div className="flex flex-col md:flex-row h-full px-6 md:px-8 pb-8">
          ...
          <div className="flex-1 md:pl-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              ...
              <div className="space-y-4" style={{
                animationDelay: '0.7s',
                animation: dropdownOpen ? 'slideInUp 1s ease-out forwards' : 'none'
              }}>
                <h3 className="text-xl font-semibold text-white mb-4">
                  {programsData.bachelor.title}
                </h3>
