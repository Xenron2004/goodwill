  ...
  return (
    <section className="w-full overflow-hidden relative">
      <div className="max-w-7xl  flex flex-col items-center justify-center mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        {/* Hero Content */}
        <div className="flex flex-col lg:flex-row place-items-end justify-end  gap-6 lg:gap-16 mb-12 lg:mb-20">
          ...
          <div className="flex flex-col w-full lg:w-auto lg:max-w-sm gap-4 lg:gap-6">
            <div className="flex flex-col gap-2">
              <h2 className="font-semibold font-['Helvetica_Neue-Regular',Helvetica] text-[#212b36] text-xs lg:text-sm tracking-wider uppercase">
        ...
        <div className="flex flex-col mt-[100px] gap-8 lg:gap-12 mb-12 lg:mb-20">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-8 max-w-5xl">
            <h4 className="lg:max-w-xs font-['Helvetica_Neue-Regular',Helvetica] font-medium text-[#212b36] text-sm lg:text-base leading-relaxed">
              Leading with Purpose and Values.
            </h4>

            <p className="lg:max-w-md font-['Helvetica_Neue-Regular',Helvetica] font-normal text-[#666d80] text-sm lg:text-base leading-relaxed">
