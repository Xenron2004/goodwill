      ...
      <div className="flex flex-col flex-1 w-full lg:max-w-[432px] items-start gap-6 lg:gap-[35px] relative">
        <div className="flex flex-col items-start gap-6 lg:gap-8 relative self-stretch w-full">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="relative w-full max-w-[374px] mt-[-1.00px] font-['Playfair_Display',Helvetica] font-normal text-black text-3xl lg:text-5xl tracking-[0] leading-tight lg:leading-[62.4px]"
          >
          ...
          <div className="flex flex-col items-start gap-6 lg:gap-[30px] relative self-stretch w-full">
            <motion.p
              ...
              viewport={{ once: true }}
              className="relative self-stretch mt-[-1.00px] font-['Helvetica_Neue-Light',Helvetica] font-light text-[#243646] text-sm lg:text-base tracking-[0] leading-relaxed lg:leading-[22.4px]"
            >
            ...
            className="relative self-stretch font-['Helvetica_Neue-Light',Helvetica] font-light text-[#243646] text-sm lg:text-base tracking-[0] leading-relaxed lg:leading-6">
