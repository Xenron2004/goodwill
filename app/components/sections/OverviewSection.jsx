...
export function OverviewSection() {
  return (
    <section className=" w-full h-[500px] sm:h-[600px] lg:h-[740px] bg-gradient-to-r from-black/30 to-black/30 bg-[url('https://images.pexels.com/photos/1579253/pexels-photo-1579253.jpeg')] bg-cover bg-center">
      ...
      <div className="absolute bottom-8 sm:bottom-12 lg:bottom-[146px] left-4 sm:left-8 lg:left-20">
